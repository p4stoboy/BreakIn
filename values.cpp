...
color clr_background = color_from_hex("#000000");
color clr_paddle = color_from_hex("#FBF6E0");
color clr_block = color_from_hex("#FBF6E0");
color clr_bullet_standard = color_from_hex("#FBF6E0");
color clr_bullet_explosion = color_from_hex("#FF2727");
color clr_bullet_acid = color_from_hex("#AFFF26");
